...
function getList(){
    axios.get("https://api.vschool.io/takeshi/todo")
...
function displayList(list){
    ...
    for(let i = 0; i < list.length; i ++){
        ...
        newlistItemDiv.style.padding= "10px"
        newlistItemDiv.style.alignItems = "center"
        newlistItemDiv.style.backgroundColor = "lightpink"
        ...
        checkbox.addEventListener('change', function(){
            if(checkbox.checked === true){
                axios.put("https://api.vschool.io/takeshi/todo/" + id, completedUpdate)
                    .then(response => getList())
                    .catch(err => console.log(err))
            } else if (checkbox.checked === false){
                axios.put("https://api.vschool.io/takeshi/todo/" + id, notCompletedUpdate)
                    .then(response => getList())
                    .catch(err => console.log(err))
            }
        })
        ...
        deleteBtn.addEventListener('click', function(){
            axios.delete("https://api.vschool.io/takeshi/todo/" + id)
                .then(response => getList())
                .catch(err => console.log(err))
        })
        ...
        editBtn.addEventListener('click', function(){
            ...
            saveBtn.addEventListener("click", function(){
                ...
                axios.put("https://api.vschool.io/takeshi/todo/" + id, updatedInfo)
                    .then(response => getList())
                    .catch(err => console.log(err))
...
inputForms.addEventListener("submit", function(e){
    ...
    axios.post("https://api.vschool.io/takeshi/todo", newListItem)
        .then(result => getList())
        .catch(err => console.log(err))
